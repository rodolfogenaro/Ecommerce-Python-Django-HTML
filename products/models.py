...
class AvailableManager(models.Manager):
    def get_queryset(self):
        return super().get_queryset().exclude(is_available=0)
...
class Product(TimeStampedModel):
    ...
    def get_buy_url(self):
        return reverse("products:buy", kwargs={"slug": self.slug})
    
    def get_edit_url(self):
        return reverse("products:edit", kwargs={"slug": self.slug})
    
    def get_purchasemade_url(self):
        return reverse("products:purchasemade", kwargs={"slug": self.slug})
